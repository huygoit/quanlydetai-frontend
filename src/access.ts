...
export default function access(initialState: AccessInitialState | undefined) {
  ...
  return {
    ...
    canViewCountries: has(PERM.country.view),
    canCreateCountry: has(PERM.country.create),
    canEditCountry: has(PERM.country.update),
    canViewUniversities: has(PERM.university.view),
    canCreateUniversity: has(PERM.university.create),
    canEditUniversity: has(PERM.university.update),
    ...
    canViewStaffPositions: has(PERM.staff_position.view),
    canCreateStaffPosition: has(PERM.staff_position.create),
    canEditStaffPosition: has(PERM.staff_position.update),
